 ...
 *
 *=========================================================================*/
/** Some of the components in this file originated from work in the Cjyx4
...
main(int argc, char * argv[])
{
  ...
  else
  {
    ...
    if (!fixedLandmarksFile.empty() || !movingLandmarksFile.empty())
    {
      ...
      // NOTE: ReadCjyx3toITKLmk returns points in LPS system
      LocalLandmarksMapType fixedLandmarkMap = ReadCjyx3toITKLmk(fixedLandmarksFile);
      LocalLandmarksMapType movingLandmarkMap = ReadCjyx3toITKLmk(movingLandmarksFile);
