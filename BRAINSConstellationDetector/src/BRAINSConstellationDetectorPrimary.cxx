...
BRAINSConstellationDetectorPrimary::Compute()
{
  ...
  const LandmarksMapType constant_orig_lmks =
    (!this->orig_lmks_filename.empty()) ? ReadCjyx3toITKLmk(this->orig_lmks_filename) : LandmarksMapType{};
  ...
  else
  {
    ...
    if (globalImagedebugLevel > 2)
    {
      ...
      WriteITKtoCjyx3Lmk(hough_eye_landmarks_fn, orig_lmks);
    }
  ...
  */
  ...
  //  std::cout << "\n\nHACK: REMOVE ME\n\n" << std::endl;
  //
  //  WriteITKtoCjyx3Lmk(dggpath + "eye_orig_space.fcsv", orig_lmks);
  //  WriteITKtoCjyx3Lmk(dggpath + "eye_fixed_space.fcsv", eyeFixed_lmks);
  //
  ...
  {
    WriteITKtoCjyx3Lmk(this->m_outputLandmarksInInputSpace, this->m_outputLandmarksInInputSpaceMap);
  ...
  {
    WriteITKtoCjyx3Lmk(this->m_outputLandmarksInACPCAlignedSpace, this->m_outputLandmarksInACPCAlignedSpaceMap);
  ...
  // ----------------------
  if (this->m_outputDRML.compare("") != 0)
  {
    WriteDRMLFile(this->m_outputDRML,
                  this->m_outputLandmarksInInputSpace,
                  this->m_outputLandmarksInACPCAlignedSpace,
                  this->m_inputVolume,
    ...
    std::cout << "The output drml scene file is written." << std::endl;
  }
