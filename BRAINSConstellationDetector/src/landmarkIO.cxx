...
// INFO:  Determine what the interface for WriteDRMLFile really needs to produce
// a useful file, and then limit the interface to just that.
extern void
WriteDRMLFile(const std::string &                                   outputDRML,
              ...
              const LandmarkIO::VersorRigidTransformType::ConstPointer & versorTransform)
{
  ...
  std::string drmlFullFilename = itksys::SystemTools::CollapseFullPath(outputDRML.c_str());
  ...
  std::ofstream myfile(drmlFullFilename.c_str());
  if (!myfile.is_open())
  {
    itkGenericExceptionMacro(<< "Cannot write drml file!" << drmlFullFilename);
  }

  // Common drml header
  myfile
    << "<DRML  version=\"13298\" userTags=\"\">  \n  <Selection  \n  id=\"vtkDRMLSelectionNode1\"  "
       "name=\"vtkDRMLSelectionNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "activeVolumeID=\"vtkDRMLScalarVolumeNode2\"  secondaryVolumeID=\"NULL\"  activeLabelVolumeID=\"NULL\"  "
       "activeFiducialListID=\"vtkDRMLFiducialListNode1\"  activeROIListID=\"NULL\"  activeCameraID=\"NULL\"  "
       "activeViewID=\"NULL\"  activeLayoutID=\"vtkDRMLLayoutNode1\"></Selection>  \n  <Interaction  \n  "
       "id=\"vtkDRMLInteractionNode1\"  name=\"vtkDRMLInteractionNode1\"  hideFromEditors=\"true\"  "
       "selectable=\"true\"  selected=\"false\"  currentInteractionMode=\"ViewTransform\"  "
       "lastInteractionMode=\"ViewTransform\" ></Interaction>  \n  <Layout  \n  id=\"vtkDRMLLayoutNode1\"  "
       "name=\"vtkDRMLLayoutNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       ...
       "></Layout>  \n  <TGParameters  \n  id=\"vtkDRMLChangeTrackerNode1\"  name=\"vtkDRMLChangeTrackerNode1\"  "
       ...
       "prescribedSliceSpacing=\"1 1 1\" ></Slice>  \n  <SliceComposite  \n  id=\"vtkDRMLSliceCompositeNode1\"  "
       "name=\"vtkDRMLSliceCompositeNode1\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "backgroundVolumeID=\"vtkDRMLScalarVolumeNode1\"  foregroundVolumeID=\"\"  labelVolumeID=\"\"  "
       ...
       "\n  id=\"vtkDRMLSliceNode2\"  name=\"Red\"  hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       ...
       "<SliceComposite  \n  id=\"vtkDRMLSliceCompositeNode2\"  name=\"vtkDRMLSliceCompositeNode2\"  "
       ...
       "\n  id=\"vtkDRMLSliceNode3\"  name=\"Yellow\"  hideFromEditors=\"true\"  selectable=\"true\"  "
       ...
       "1\" ></Slice>  \n  <SliceComposite  \n  id=\"vtkDRMLSliceCompositeNode3\"  name=\"vtkDRMLSliceCompositeNode3\" "
       " hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  "
       "backgroundVolumeID=\"vtkDRMLScalarVolumeNode1\"  foregroundVolumeID=\"\"  labelVolumeID=\"\"  "
       "compositing=\"0\"  labelOpacity=\"1\"  linkedControl=\"0\"  foregroundGrid=\"0\"  backgroundGrid=\"0\"  "
       "labelGrid=\"1\"  fiducialVisibility=\"1\"  fiducialLabelVisibility=\"1\"  sliceIntersectionVisibility=\"0\"  "
       "layoutName=\"Yellow\"  annotationMode=\"All\"  doPropagateVolumeSelection=\"1\" ></SliceComposite>  \n  "
       "<ScriptedModule  \n  id=\"vtkDRMLScriptedModuleNode1\"  name=\"vtkDRMLScriptedModuleNode1\"  "
       "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\" ModuleName =\"Editor\" parameter0= \"label "
       "1\" ></ScriptedModule>  \n  <View  \n  id=\"vtkDRMLViewNode1\"  name=\"View6\"  hideFromEditors=\"false\"  "
       ...
       " \n  id=\"vtkDRMLCameraNode1\"  name=\"Camera6\"  hideFromEditors=\"false\"  selectable=\"true\"  "
       "selected=\"false\"  position=\"0 500 0\"  focalPoint=\"0 0 0\"  viewUp=\"0 0 1\"  parallelProjection=\"false\" "
       " parallelScale=\"1\"  activetag=\"vtkDRMLViewNode1\" ></Camera>  \n";

  // For fiducial landmarks in output space
  if (outputLandmarksInOutputSpace.compare("") != 0)
  {
    myfile << "<FiducialList\n id=\"vtkDRMLFiducialListNode1\" name=\""
           << outputLandmarksInOutputSpaceFullFilenameWithoutExtension
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkDRMLFiducialListStorageNode1\" userTags=\"\" symbolScale=\"5\" symbolType=\"13\" "
    ...
    myfile << "<FiducialListStorage\n id=\"vtkDRMLFiducialListStorageNode1\" name=\"vtkDRMLFiducialListStorageNode1\" "
  ...
  if (outputLandmarksInInputSpace.compare("") != 0)
  {
    myfile << "<FiducialList\n id=\"vtkDRMLFiducialListNode2\" name=\""
           << outputLandmarksInInputSpaceFullFilenameWithoutExtension
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkDRMLFiducialListStorageNode2\" userTags=\"\" symbolScale=\"5\" symbolType=\"13\" "
              "textScale=\"4.5\" visibility=\"1\" color=\"0.4 1 1\" selectedcolor=\"1 0.5 0.5\" ambient=\"0\" "
              "diffuse=\"1\" specular=\"0\" power=\"1\" locked=\"0\" opacity=\"1\" fiducials=\"\n";
    ...
    myfile << "<FiducialListStorage\n id=\"vtkDRMLFiducialListStorageNode2\" name=\"vtkDRMLFiducialListStorageNode2\" "
              "hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" fileName=\""
  ...
  if (outputVolume.compare("") != 0)
  {
    ...
    myfile << "<VolumeArchetypeStorage\n id=\"vtkDRMLVolumeArchetypeStorageNode1\" "
              "name=\"vtkDRMLVolumeArchetypeStorageNode1\" hideFromEditors=\"true\" selectable=\"true\" "
    ...
    myfile << "<Volume\n id=\"vtkDRMLScalarVolumeNode1\" name=\"" << outputVolumeFilenameWithoutPath
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkDRMLVolumeArchetypeStorageNode1\" userTags=\"\" "
              "displayNodeRef=\"vtkDRMLScalarVolumeDisplayNode1\" ijkToRASDirections=\"";
    ...
    myfile << "\" spacing=\"" << doubleToString(spacing[0]) << " " << doubleToString(spacing[1]) << " "
           ...
           << "\" labelMap=\"0\"></Volume>\n<VolumeDisplay\n id=\"vtkDRMLScalarVolumeDisplayNode1\" "
              "name=\"vtkDRMLScalarVolumeDisplayNode1\" hideFromEditors=\"true\" selectable=\"true\" "
              ...
              "autoScalarRange=\"true\" scalarRange=\"0 100\" colorNodeRef=\"vtkDRMLColorTableNodeGrey\"  "
  ...
  if (inputVolume.compare("") != 0)
  {
    ...
    ImageType::SpacingType   spacing = reader->GetOutput()->GetSpacing();
    ImageType::PointType     origin = reader->GetOutput()->GetOrigin();
    myfile << "<VolumeArchetypeStorage\n id=\"vtkDRMLVolumeArchetypeStorageNode2\" "
              "name=\"vtkDRMLVolumeArchetypeStorageNode2\" hideFromEditors=\"true\" selectable=\"true\" "
              "selected=\"false\" fileName=\""
           << inputVolumeFullFilename
           << "\" useCompression=\"1\" readState=\"0\" writeState=\"0\" centerImage=\"0\" singleFile=\"0\" "
              "UseOrientationFromFile=\"1\"></VolumeArchetypeStorage>\n";

    myfile << "<Volume\n id=\"vtkDRMLScalarVolumeNode2\" name=\"" << inputVolumeFilenameWithoutPath
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkDRMLVolumeArchetypeStorageNode2\" userTags=\"\" "
              "displayNodeRef=\"vtkDRMLScalarVolumeDisplayNode2\" ijkToRASDirections=\"";
    for (unsigned int i = 0; i < LocalImageDimension; ++i)
    {
      for (unsigned int j = 0; j < LocalImageDimension; ++j)
      {
    ...
    myfile << "\" spacing=\"" << doubleToString(spacing[0]) << " " << doubleToString(spacing[1]) << " "
           << doubleToString(spacing[2]) << "\" origin=\"" << doubleToString(origin[0]) << " "
           << doubleToString(origin[1]) << " " << doubleToString(origin[2])
           << "\" labelMap=\"0\"></Volume>\n<VolumeDisplay\n id=\"vtkDRMLScalarVolumeDisplayNode2\" "
              "name=\"vtkDRMLScalarVolumeDisplayNode2\" hideFromEditors=\"true\" selectable=\"true\" "
              "selected=\"false\" color=\"0.5 0.5 0.5\" selectedColor=\"1 0 0\" selectedAmbient=\"0.4\" ambient=\"0\" "
              "diffuse=\"1\" selectedSpecular=\"0.5\" specular=\"0\" power=\"1\" opacity=\"1\" visibility=\"true\" "
              "clipping=\"false\" sliceIntersectionVisibility=\"false\" backfaceCulling=\"true\" "
              "scalarVisibility=\"false\" vectorVisibility=\"false\" tensorVisibility=\"false\" "
  ...
  if (outputTransform.compare("") != 0)
  {
    ...
    myfile << "<TransformStorage  \n  id=\"vtkDRMLTransformStorageNode1\"  name=\"vtkDRMLTransformStorageNode1\"  "
              "hideFromEditors=\"true\"  selectable=\"true\"  selected=\"false\"  fileName=\""
           << outputTransformFullFilename
           << "\"  useCompression=\"1\"  readState=\"0\"  writeState=\"0\" ></TransformStorage>  \n"
           << "<LinearTransform  \n  id=\"vtkDRMLLinearTransformNode1\"  name=\"" << outputTransformFilenameWithoutPath
           << "\"  hideFromEditors=\"false\"  selectable=\"true\"  selected=\"false\"  "
              "storageNodeRef=\"vtkDRMLTransformStorageNode1\"  userTags=\"\"  matrixTransformToParent=\"";
    for (unsigned int i = 0; i < LocalImageDimension; ++i)
    {
      for (unsigned int j = 0; j < LocalImageDimension; ++j)
      {
                        ...
                        const std::string & saveOutputLandmarksFilename)
{
  ...
  ScriptFile << "##points and writes out a cjyx .fcsv file with 3 landmark points in it" << std::endl;
  ...
  ScriptFile << "set volumesLogic [$::cjyx3::VolumesGUI GetLogic]" << std::endl;
  ScriptFile << "set fidLogic [$::cjyx3::FiducialsGUI GetLogic]" << std::endl;
  ScriptFile << std::endl;
  ...
  ScriptFile << "set selectionNode [$::cjyx3::ApplicationLogic GetSelectionNode]" << std::endl;
  ScriptFile << "$selectionNode SetReferenceActiveVolumeID [$volumeNode GetID]" << std::endl;
  ScriptFile << "$::cjyx3::ApplicationLogic PropagateVolumeSelection" << std::endl;
  ScriptFile << std::endl;
