...
QLabelList::writeLandmarks()
{
  ...
  // get proper filename for fcsv and drml file
  ...
  // write scene to drml file
  QString drmlFullFilename = landmarksFullFilenameWithoutExtension + ".drml";
  {
    QFile output(drmlFullFilename);
    if (!output.open(QIODevice::WriteOnly | QIODevice::Truncate))
    {
      std::cerr << "Cannot write drml file!" << std::endl;
      exit(-1);
    }
    QTextStream myfile(&output);

    myfile
      << "<DRML userTags=\"\">\n<Selection\n id=\"vtkDRMLSelectionNode1\" name=\"vtkDRMLSelectionNode1\" "
         "hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" activeVolumeID=\"vtkDRMLScalarVolumeNode1\" "
         ...
         "activeLayoutID=\"vtkDRMLLayoutNode1\"></Selection>\n<Interaction\n id=\"vtkDRMLInteractionNode1\" "
         "name=\"vtkDRMLInteractionNode1\" hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" "
         "currentInteractionMode=\"ViewTransform\" lastInteractionMode=\"ViewTransform\"></Interaction>\n<Layout\n "
         "id=\"vtkDRMLLayoutNode1\" name=\"vtkDRMLLayoutNode1\" hideFromEditors=\"true\" selectable=\"true\" "
         ...
         "id=\"vtkDRMLViewNode1\" name=\"vtkDRMLViewNode1\" hideFromEditors=\"true\" selectable=\"true\" "
         ...
         "id=\"vtkDRMLCameraNode1\" name=\"vtkDRMLCameraNode1\" hideFromEditors=\"true\" selectable=\"true\" "
         "selected=\"false\" position=\"0 500 0\" focalPoint=\"0 0 0\" viewUp=\"0 0 1\" parallelProjection=\"false\" "
         "parallelScale=\"1\" active=\"false\"></Camera>\n<TGParameters\n id=\"vtkDRMLChangeTrackerNode1\" "
         "name=\"vtkDRMLChangeTrackerNode1\" hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" "
         ...
         "UseITK=\"1\"></TGParameters>\n<VolumeRenderingSelection\n id=\"vtkDRMLVolumeRenderingSelectionNode1\" "
         "name=\"vtkDRMLVolumeRenderingSelectionNode1\" hideFromEditors=\"true\" selectable=\"true\" "
         "selected=\"false\" activeVolumeID=\"NULL\" "
         "activeVolumeRenderingID=\"NULL\"></VolumeRenderingSelection>\n<Slice\n id=\"vtkDRMLSliceNode1\" "
         ...
         "backgroundVolumeID=\"vtkDRMLScalarVolumeNode1\" foregroundVolumeID=\"\" labelVolumeID=\"\" compositing=\"0\" "
         ...
         "sliceVisibility=\"false\" widgetVisibility=\"false\" useLabelOutline=\"false\" sliceSpacingMode=\"0\" "
         "prescribedSliceSpacing=\"1 1 1\"></Slice>\n<SliceComposite\n id=\"vtkDRMLSliceCompositeNode3\" "
         "name=\"vtkDRMLSliceCompositeNode3\" hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" "
         "backgroundVolumeID=\"vtkDRMLScalarVolumeNode1\" foregroundVolumeID=\"\" labelVolumeID=\"\" compositing=\"0\" "
         "labelOpacity=\"1\" linkedControl=\"1\" foregroundGrid=\"0\" backgroundGrid=\"0\" labelGrid=\"1\" "
         "fiducialVisibility=\"1\" fiducialLabelVisibility=\"1\" sliceIntersectionVisibility=\"0\" "
         ...
         "-148 114\"></Crosshair>\n<ScriptedModule\n id=\"vtkDRMLScriptedModuleNode1\" "
         "name=\"vtkDRMLScriptedModuleNode1\" hideFromEditors=\"true\" selectable=\"true\" selected=\"false\" "
         "ModuleName =\"Editor\" parameter0= \"label 1\"></ScriptedModule>\n";

    myfile << "<FiducialList\n id=\"vtkDRMLFiducialListNode1\" name=\"" << landmarksFullFilenameWithoutExtension
           << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
              "storageNodeRef=\"vtkDRMLFiducialListStorageNode1\" userTags=\"\" symbolScale=\"5\" symbolType=\"11\" "
    ...
    myfile
      << "<FiducialListStorage\n id=\"vtkDRMLFiducialListStorageNode1\" "
      << "name=\"vtkDRMLFiducialListStorageNode1\" hideFromEditors=\"true\" "
      ...
      << "name=\"vtkDRMLVolumeArchetypeStorageNode1\" hideFromEditors=\"true\""
      ...
      << "<Volume\n id=\"vtkDRMLScalarVolumeNode1\" name=\"" << imageFilenameWithoutPath
      << "\" hideFromEditors=\"false\" selectable=\"true\" selected=\"false\" "
      << "storageNodeRef=\"vtkDRMLVolumeArchetypeStorageNode1\" userTags=\"\" "
      << "displayNodeRef=\"vtkDRMLScalarVolumeDisplayNode1\" ijkToRASDirections=\"-1 "
      << "  -0   0 -0   -0   1 0 1 0 \" spacing=\"1 1 1\" origin=\"-0 -255 -0\" "
      << "labelMap=\"0\"></Volume>\n<VolumeDisplay\n id=\"vtkDRMLScalarVolumeDisplayNode1\" "
      << "name=\"vtkDRMLScalarVolumeDisplayNode1\" hideFromEditors=\"true\" "
      ...
      << "scalarRange=\"0 100\" colorNodeRef=\"vtkDRMLColorTableNodeGrey\"  "
