...
CJYX_EXTENSION_BIN=/Users/johnsonhj/Desktop/Cjyx.app/Contents/Extensions-25603/CjyxDMRI/lib/Cjyx-4.7/cli-modules

DWIIN=$1
BASENAME=${DWIIN//.nhdr/}
DTIOUT=${BASENAME}_CjyxDTI.nrrd
DWIBRAINMASK=${BASENAME}_BrainMask.nrrd
BASELINEOUT=${BASENAME}_Baseline.nrrd
BASELINEOUTDTI=${BASENAME}_DTIBaseline.nrrd
FA=${BASENAME}_CjyxFA.nrrd
MD=${BASENAME}_CjyxMD.nrrd
...
${CJYX_EXTENSION_BIN}/DiffusionWeightedVolumeMasking \
...
${CJYX_EXTENSION_BIN}/DWIToDTIEstimation \
  --enumeration LS \
  --mask ${DWIBRAINMASK} \
...
${CJYX_EXTENSION_BIN}/DiffusionTensorScalarMeasurements \
