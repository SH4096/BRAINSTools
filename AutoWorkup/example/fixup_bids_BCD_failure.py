# HINT:
# Setup Cjyx Starup script for being in the Markups module
# echo "cjyx.util.selectModule('Markups')" >>  ~/.cjyxrc.py
...
CJYX_BIN = "/home/johnsonhj/local/apps/Cjyx3D/4.11.0.20200627/Cjyx"
...
for run_info in REVIEWS_NEEDED:
    ...
    if review_file.is_file():
        ...
        if not acpc_fixedlmk.is_file():
            ...
            cmd = [f"{CJYX_BIN}", str(failed_lmks), str(acpc_t1w)]
        ...
        if do_bcd:
            ...
            if do_final_review:
                ...
                cmd = [
                    "/home/johnsonhj/Downloads/Cjyx-4.11.0-2020-06-12-linux-amd64/Cjyx",
                    str(acpc_lmk),
                    str(acpc_t1w),
                ]
                run_it(cmd, False, True)
