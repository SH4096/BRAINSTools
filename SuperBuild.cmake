...
option(USE_SYSTEM_CjyxExecutionModel "Build using an externally defined version of CjyxExecutionModel"  OFF)
...
list(APPEND ${LOCAL_PROJECT_NAME}_DEPENDENCIES CjyxExecutionModel)
...
mark_as_superbuild( # Local project
  ...
  #    ${LOCAL_PROJECT_NAME}_SUPERBUILD:BOOL
    ...
    USE_SYSTEM_CjyxExecutionModel:BOOL
    CjyxExecutionModel_DIR:PATH
    CjyxExecutionModel_DEFAULT_CLI_RUNTIME_OUTPUT_DIRECTORY:PATH
    CjyxExecutionModel_DEFAULT_CLI_LIBRARY_OUTPUT_DIRECTORY:PATH
    CjyxExecutionModel_DEFAULT_CLI_ARCHIVE_OUTPUT_DIRECTORY:PATH
    CjyxExecutionModel_DEFAULT_CLI_INSTALL_RUNTIME_DESTINATION:PATH
    CjyxExecutionModel_DEFAULT_CLI_INSTALL_LIBRARY_DESTINATION:PATH
    CjyxExecutionModel_DEFAULT_CLI_INSTALL_ARCHIVE_DESTINATION:PATH
