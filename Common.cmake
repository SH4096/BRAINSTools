...
if(NOT Cjyx_BUILD_BRAINSTOOLS)
  ...
  set(BUILD_SHARED_LIBS OFF) ## Build everything static for non-cjyx builds
  set(EXTERNAL_BUILD_SHARED_LIBS OFF) ## Build external projects shared
else()
  set(BUILD_SHARED_LIBS ON) ## Build everything static for non-cjyx builds
...
# -- if(NOT Cjyx_BUILD_BRAINSTOOLS AND BUILD_TESTING)
