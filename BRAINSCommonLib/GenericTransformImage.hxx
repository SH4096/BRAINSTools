...
GetInterpolatorFromString(const std::string & interpolationMode)
{
  ...
  //
  // WindowRadius set to 3 to match default for Cjyx
  static constexpr unsigned int CjyxWindowedSincWindowRadius = 3;
  ...
  {
    using WindowFunctionType = typename itk::Function::
      HammingWindowFunction<CjyxWindowedSincWindowRadius, TInterpolatorPrecisionType, TInterpolatorPrecisionType>;
    using InterpolatorType = typename itk::WindowedSincInterpolateImageFunction<InputImageType,
                                                                                CjyxWindowedSincWindowRadius,
                                                                                WindowFunctionType,
                                                                                BoundaryConditionType,
                                                                                TInterpolatorPrecisionType>;
    return (InterpolatorType::New()).GetPointer();
  ...
  {
    using WindowFunctionType = typename itk::Function::
      CosineWindowFunction<CjyxWindowedSincWindowRadius, TInterpolatorPrecisionType, TInterpolatorPrecisionType>;
    using InterpolatorType = typename itk::WindowedSincInterpolateImageFunction<InputImageType,
                                                                                CjyxWindowedSincWindowRadius,
                                                                                WindowFunctionType,
                                                                                BoundaryConditionType,
  ...
  {
    using WindowFunctionType = typename itk::Function::
      WelchWindowFunction<CjyxWindowedSincWindowRadius, TInterpolatorPrecisionType, TInterpolatorPrecisionType>;
    using InterpolatorType = typename itk::WindowedSincInterpolateImageFunction<InputImageType,
                                                                                CjyxWindowedSincWindowRadius,
                                                                                WindowFunctionType,
                                                                                BoundaryConditionType,
  ...
  {
    using WindowFunctionType = typename itk::Function::
      LanczosWindowFunction<CjyxWindowedSincWindowRadius, TInterpolatorPrecisionType, TInterpolatorPrecisionType>;
    using InterpolatorType = typename itk::WindowedSincInterpolateImageFunction<InputImageType,
                                                                                CjyxWindowedSincWindowRadius,
                                                                                WindowFunctionType,
                                                                                BoundaryConditionType,
  ...
  {
    using WindowFunctionType = typename itk::Function::
      BlackmanWindowFunction<CjyxWindowedSincWindowRadius, TInterpolatorPrecisionType, TInterpolatorPrecisionType>;
    using InterpolatorType = typename itk::WindowedSincInterpolateImageFunction<InputImageType,
                                                                                CjyxWindowedSincWindowRadius,
                                                                                WindowFunctionType,
                                                                                BoundaryConditionType,
