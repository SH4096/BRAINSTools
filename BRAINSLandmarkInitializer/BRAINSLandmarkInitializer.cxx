                        ...
                        LandmarkWeightType &     landmarkWgts)
{
  ...
  LandmarksMapType fixedLandmarks = ReadCjyx3toITKLmk(inputFixedLandmarkFilename);

  std::cout << "Reading moving landmarks set: " << inputMovingLandmarkFilename << std::endl;
  LandmarksMapType movingLandmarks = ReadCjyx3toITKLmk(inputMovingLandmarkFilename);
